...
export function getMonitorDimensionsForType(type: Discovery['type']): MonitorDimension[] {
  return TYPE_DIMENSIONS[getMonitorType({ type } as Discovery)] ?? TYPE_DIMENSIONS.general;
}

export function getMonitoringCadence(status: MonitorStatus, activeTripRelevant: boolean): string {
